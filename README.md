...
Ans: var: Old JavaScript variables, function scoped, can be re-declared.
let: Block scoped, value can be changed but cannot be declared again in the same scope.
const: Block scoped, value cannot be changed after declaration

What is the spread operator (...)?
Ans: ... used to spread/copy elements of an array or object
